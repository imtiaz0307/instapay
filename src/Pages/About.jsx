...
const About = () => {
    return (
        <div>
            <NavbarFooter />
            <SidebarFixed featureText={"Legal And Regulatory"} color='#000' />
            <main className={styles.content}>
                <h1>About Us</h1>
                <section className={styles.top}>
                    <div className={styles.left}>
                        <h2>KEMIT KINGDOM: A Regulated Entity</h2>
                        <p>InstaPay, a cutting-edge financial platform, is powered by Kemit Kingdom (K2) SA. As <Link to={"/"}>a financial intermediary in Switzerland</Link>, we strictly adhere to the Swiss Anti-Money Laundering Act. We are part of the Financial Services Standards Association (<Link to={"/"}>SOFIT</Link>), the largest self-regulatory organization (SRO) in Switzerland, based in Geneva. This ensures our commitment to high regulatory standards and practices.</p>
                    </div>
