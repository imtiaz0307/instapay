    ...
    return (
        <div>
            ...
            <main className={styles.content}>
                ...
                <div>
                    <h4>Clear and easily accessible Statements of Practices and Policies</h4>

                    <p>As a part of Kemit Kingdom ongoing efforts to ensure the compliance of modern Fintech approach, customer trust/ satisfaction, security oriented service and financial services, Kemit Kingdom has adopted the privacy policy aimed at protecting individual’s personal information entrusted and disclosed to InstaPay (the "Policy"). This Policy governs the way in which InstaPay collects, uses, discloses, stores, secures and disposes of personal information.</p>

                    <br />
                    <br />

                    <p>In this policy ("us", "we", "our", “K2” or “Kemit Kingdom SA”) means InstaPay, that  operates <Link to={"/"}>https://www.insta-pay.ch/</Link> (the "App", “Chat Bot”), and “you”, “your” or “yours” means the persons to whom this policy applies.</p>
                    ...
                    <br />
                    <br />
                    <p>We use your Personal Information only for providing and improving InstaPay app. By using the app, you agree to the collection and use of information in accordance with this policy.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>“Personal Information” is data that can be used to identify a natural person. Some examples of personal information that we may collect are:</p>
                    <br />
                    <br />
                    <ul>
                        {dataCollect.map(item => <li key={item}>{item}</li>)}
                    </ul>
                </div>

                <div>
                    <h4>Use of Personal Information</h4>
                    <p>InstaPay app collects and uses the financial information and other personal information from its customers. This information is used for specific business purposes or for other related purposes designated by InstaPay or for a lawful purpose to comply with the applicable laws and regulations, and will include:</p>
                    <br />
                    <br />
                    <ul>
                    ...
                    <br />
                    <br />
                    <p>We may also use personal information for purposes set out in the terms and conditions that govern our relationship with you or our customer.</p>

                    <br />
                    <br />
                    <p>InstaPay may divulge some personal information collected from the customer, for cross selling or any other purposes.</p>
                    <br />
                    <br />
                    <p>The authenticity of the personal information provided by the customer shall not be the responsibility of InstaPay.</p>
                    <br />
                    <br />
                    <p>Any information that is freely available or accessible in public domain shall not be regarded as personal information for the purposes of this Policy and InstaPay shall not be responsible for the same.</p>
                </div>

                <div>
                    <h4>Disclosure of personal information</h4>
                    <p>The personal information collected by InstaPay shall not be disclosed to other organization except:</p>
                    <br />
                    <br />
                    <ul>
                        {disclosureConditions.map(item => <li key={item}>{item}</li>)}
                    </ul>
                </div>

                <div>
                    <h4>Withdrawal of Consent to use or correction of your Personal Information</h4>
                    <p>Sharing of personal information with InstaPay is voluntary and in case customer wishes to withdraw its consent or make modifications to the personal information, customer can do so by suspending their subscription to the Wakanda app and customer accepts the effects of such withdrawal.</p>
                </div>

                <div>
                    <h4>Cookies and Related Technologies</h4>
                    <p>Our website and mobile application (“app”) use cookies. A cookie is a small text file placed on your computer or mobile device when you visit a website or use an app. Cookies collect information about users and their visit to the website or use of the app, such as their Internet protocol (IP) address, how they arrived at the website (for example, through a search engine or a link from another website) and how they navigate within the website or app. We use cookies and other technologies to facilitate your internet sessions and use of our apps, offer you products and/or services according to your preferred settings, track use of our websites and apps and to compile statistics about activities carried out on our websites and/or through our apps.</p>
                    <br />
                    <br />
                    <p>A pixel tag, also known as a web beacon, is an invisible tag placed on certain pages of our website but not on your computer. Pixel tags are usually used in conjunction with cookies and are used to monitor the behaviour of users visiting the website.</p>
                    <br />
                    <br />
                    <p>You may set up your web browser to block cookies which will in turn disable the pixel tags from monitoring your website visit. You may also remove cookies stored from your computer or mobile device. However, if you do block cookies and pixel tags, you may not be able to use certain features and functions of our websites.</p>
                    <br />
                    <br />
                    <p>We seek certain app permissions at the time of installation on your mobile device, providing us access to data on your mobile device to make your financial experience personalized and enabling us to offer you relevant products and services. Should you wish to modify or disable these permissions, you can change the app settings on your mobile device at any time. Do note that some of the functionality and offers on the app may get impacted by this action.</p>
                </div>

                <div>
                    <h4>Other websites</h4>
                    <p>Our websites may contain links to other websites which are not maintained by InstaPay. This privacy policy only applies to the websites of Instapay. When visiting these third party websites, you should read their privacy policies which will apply to your use of the websites.</p>
                </div>

                <div>
                    <h4>Reasonable Security Practices and Procedures</h4>
                    <p>InstaPay shall take reasonable steps and measures to protect the security of the customer’s personal information from misuse and loss, unauthorised access, modification, or disclosure. InstaPay maintains its security systems to ensure that the personal information of the customer is appropriately protected. InstaPay ensures that its employees respect the confidentiality of any personal information held by InstaPay.</p>
                </div>

                <div>
                    <h4>Changes To This Privacy Policy</h4>
                    <p>This Privacy Policy is effective as of November 1st, 2023 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
                    <br />
                    <br />
                ...
                <div>
                    ...
                    <p>To contact us on any aspect of this policy or for any discrepancies/grievances with respect to your personal information, you may write to our support at: <Link to={"/"}>support@insta-pay.ch</Link></p>
                </div>
            </main>
        </div>
    )
